...
I am most comfortable working with Python, JavaScript, React, SQL, HTML, and CSS. I have experience building backend APIs with FastAPI and working with databases, and I have also built full-stack web applications. I want to improve my backend software engineering skills and gain experience contributing to an existing codebase. I prefer issues that are reasonably scoped for a first open-source contribution and want to avoid issues that require deep expertise in unfamiliar languages, frameworks, or infrastructure.
